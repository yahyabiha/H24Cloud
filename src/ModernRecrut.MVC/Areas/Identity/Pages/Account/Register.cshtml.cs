...
namespace ModernRecrut.MVC.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Type d'utilisateur"), Required(ErrorMessage = "Veuillez renseigner le type d'utilisateur")]
            public TypeUtilisateur TypeUtilisateur {  get; set; }

            [Display(Name = "Nom"), Required(ErrorMessage = "Veuillez renseigner le nom")]
            public string Nom {  get; set; }

            [Display(Name = "Prénom"), Required(ErrorMessage = "Veuillez renseigner le prénom")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                user.TypeUtilisateur = Input.TypeUtilisateur;
                ...
                if (result.Succeeded)
                {
                    ...
                    // Enregistrer le role
                    if (user.TypeUtilisateur == TypeUtilisateur.Employé)
                        await _userManager.AddToRoleAsync(user, TypeUtilisateur.Employé.ToString());
                    else
                        await _userManager.AddToRoleAsync(user, TypeUtilisateur.Candidat.ToString());
